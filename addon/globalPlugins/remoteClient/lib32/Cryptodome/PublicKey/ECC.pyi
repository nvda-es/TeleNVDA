...
from typing import Union, Callable, Optional, Dict, NamedTuple, Any, overload, Literal
...
def import_key(
	encoded: Union[bytes, str], passphrase: Optional[str] = None, curve_name: Optional[str] = None
) -> EccKey: ...
