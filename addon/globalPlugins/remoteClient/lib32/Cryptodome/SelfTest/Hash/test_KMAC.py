...
class NISTExampleTestVectors(unittest.TestCase):
	...
	test_data = [
		(
			...
			"00 01 02 03",
			"",
			"E5 78 0B 0D 3E A6 F7 D3 A4 29 C5 70 6A A4 3A 00FA DB D7 D4 96 28 83 9E 31 87 24 3F 45 6E E1 4E",
			"Sample #1 NIST",
			KMAC128,
		),
		(
			...
			"3B 1F BA 96 3C D8 B0 B5 9E 8C 1A 6D 71 88 8B 7143 65 1A F8 BA 0A 70 70 C0 97 9E 28 11 32 4A A5",
			"Sample #2 NIST",
			KMAC128,
		),
		(
			...
			"My Tagged Application",
			"1F 5B 4E 6C CA 02 20 9E 0D CB 5C A6 35 B8 9A 15E2 71 EC C7 60 07 1D FD 80 5F AA 38 F9 72 92 30",
			"Sample #3 NIST",
			KMAC128,
		),
		(
