...
class SlaveSession(RemoteSession):
	...
	def __init__(self, *args, **kwargs):
		...
		self.transport.callback_manager.register_callback(
			"msg_set_clipboard_text", self.handle_set_clipboard_text
		)
		...
		self.transport.callback_manager.register_callback(
			"msg_request_screenshot", self.handle_screenshot_request
		)
		self.transport.callback_manager.register_callback(
			"msg_request_screenshot_powershell", self.handle_powershell_screenshot_request
		)
		...
		self.transport.callback_manager.register_callback(
			"msg_" + mouse_control.MESSAGE_TYPE, self.handle_mouse
		)
